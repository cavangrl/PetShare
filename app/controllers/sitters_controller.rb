class SittersController < ApplicationController
  ...
  private
    ...
    def sitter_params
      params.require(:sitter).permit(:dog_id,:first_name, :last_name, :medical_status, :zip, :summary, :years_of_experience, :insurance, :full_time, :doggie_cam, :solo_care, :avatar)
    end
end